...
>
    <div
            ...
            @else
                ax-load
            @endif
            ax-load-src="{{ \Filament\Support\Facades\FilamentAsset::getAlpineComponentSrc('filament-custom-attribute-file-upload', 'elmudo-dev/filament-custom-attribute-file-upload') }}"
